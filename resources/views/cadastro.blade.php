    ...
    <form id="form" class="form-horizontal" action='products/salvar' method="POST">        
        <div class="row row-margin">
            <div class="col-xs-12 col-sm-6">
                ...
                <input type="text" class="form-control" maxlength="100" name="descricao" id="descricao"/>
            </div>
            <div class="col-xs-12 col-sm-2">
                <label for="quantidade">Quantidade do produto*:</label>               
                <input type="number" class="form-control" min="1" name="quantidade" max="99999" id="quantidade" step="1" />
            </div>  
            <div class="col-xs-12 col-sm-2">
                <label for="preco">Preço do produto*:</label>               
                <input type="number" class="form-control" min="1" name="preco" id="preco" step="1" />
            </div>    
        </div>        
